...
open class DatabaseRepository<M : ImmutableModel<M>, Key : ImmutableModel<Key>>(
    ...
    override suspend fun get(valueId: Id<M>): M? = dataSource.get(valueId)

    override suspend fun getCollection(keyId: Id<Key>): Set<M> = dataSource.getCollection(keyId).toSet()
    ...
    override suspend fun getAll(): Set<M> = dataSource.getAll().toSet()

    override suspend fun getKey(valueId: Id<M>): Id<Key>? = dataSource.getKey(valueId)
