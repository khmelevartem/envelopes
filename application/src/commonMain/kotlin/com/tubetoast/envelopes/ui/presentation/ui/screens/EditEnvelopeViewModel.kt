...
private class CreateEnvelopeMode(
    ...
    override suspend fun canConfirm(envelope: Envelope?) =
        envelope?.run {
...
private class EditEnvelopeMode(
    ...
    override suspend fun confirm(envelope: Envelope) = envelopeInteractor.editEnvelope(editedEnvelope, envelope)
}
