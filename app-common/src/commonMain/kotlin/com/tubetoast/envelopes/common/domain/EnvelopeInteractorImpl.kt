...
class EnvelopeInteractorImpl(
    ...
    override suspend fun getAll(): Set<Envelope> =
    ...
    override suspend fun getExactEnvelope(id: Id<Envelope>): Envelope? =
        withContext(dispatcher) {
            repository.get(id)
        }

    override suspend fun addEnvelope(envelope: Envelope) =
        withContext(dispatcher) {
